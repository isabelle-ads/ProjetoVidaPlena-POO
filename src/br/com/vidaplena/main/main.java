                ...
                try {
                    ...
                    switch (opcao) {
                        ...
                        case 2 -> {
                            ...
                            for (Profissional p : clinica.getProfissionais()) {
                            ...
                            switch (opPag) {
                                case 1 -> pagamentoSelected = new PagamentoDinheiro(valorBase);
                                case 2 -> pagamentoSelected = new PagamentoCartao(valorBase);
                                case 3 -> pagamentoSelected = new PagamentoConvenio(valorBase);
                                default -> System.out.println("Erro: Opção de pagamento inválida! Agendamento cancelado.");
                            }
                        ...
                        case 3 -> clinica.exibirRelatorioGeral();
                            
                        case 4 -> clinica.exibirRelatorioPagamentos();
                            
                        case 0 -> System.out.println("Encerrando o sistema VidaPlena...");
                        default -> System.out.println("Opção inválida!");
                    }
                } catch (NumberFormatException e) {
                    System.out.println("Erro: Por favor, insira um número válido.");
                } catch (br.com.vidaplena.exception.CpfDuplicadoException | br.com.vidaplena.exception.PacienteInativoException e) {
